 ...
 * endpoint — report `progress` in formats Lumen cannot resolve to a CFI.
 ...
 *
 * KOReader and Lumen paginate differently, so the server-reported
 * `percentage` is not directly comparable to Lumen's own progress. When the
