...
const ANDROID_PACKAGE = 'com.lumen.reader';
...
const OpenAnnotationLanding = () => {
  ...
  return (
    <main className='bg-base-200 flex min-h-dvh flex-col items-center justify-center p-4 sm:p-8'>
      <Card>
        <BrandHeader
          title={_('Open in Lumen')}
          subtitle={
            showManualOpen
              ? _("If Lumen didn't open automatically, choose an option below:")
        ...
        {!showManualOpen && (
          ...
          >
            ...
            <span className='text-base-content/70 text-sm'>{_('Opening Lumen...')}</span>
          </div>
        )}
