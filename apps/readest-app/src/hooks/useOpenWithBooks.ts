...
/**
 * Handle "Open with Lumen" file imports. Consumes the `app-incoming-url`
 ...
 *
 * Non-file URL shapes (https, lumen://, data:, blob:) are skipped here
 ...
 *
 *   `'VIEW'` with auto-import OFF (Android only — user picked Lumen from the
 ...
 *   syncs, which is what a "Send to Lumen" share (and an opt-in "Open
